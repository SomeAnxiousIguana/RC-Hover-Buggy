...
#define BAT_CALIB_REAL_VOLTAGE  5049      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define BAT_DEAD                (345 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
// ######################## END OF BATTERY ###############################
...
#define TEMP_CAL_LOW_DEG_C      272       // temperature 1: measured temperature [°C * 10].
...
#define TEMP_POWEROFF_ENABLE    1         // to poweroff or not to poweroff, 1 or 0, DO NOT ACTIVITE WITHOUT CALIBRATION!
...
#define I_DC_MAX        9              // [A] Maximum stage2 DC Link current limit for Commutation and Sinusoidal types (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A)
...
// Extra functionality
 ...
 #define ELECTRIC_BRAKE_MAX    8       // (0, 500) Maximum electric brake to be applied when input torque request is 0 (pedal fully released).
...
*/
  #define CONTROL_IBUS            0       // use IBUS as input. Number indicates priority for dual-input.
